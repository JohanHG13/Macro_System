...
$sql ="INSERT INTO productos (id_producto, nombreP, nom_producto, fecha_entrada, descripcion, marca, medida, cantidad_entrada, precio_entrada)
values ('$id_producto','$nombreP', '$nom_producto', '$fecha_entrada', '$descripcion','$marca ','$medida','$cantidad_entrada','$precio_entrada')";
